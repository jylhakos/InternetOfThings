...
It includes endpoints for chat completions, health checks, and agent management.
It also supports dynamic agent creation and conversation history management.
...
MODEL_NAME = os.getenv("MODEL_NAME", "llama4:scout")  # Default to Llama 4 Scout
