...
Type=simple
User=laptop
WorkingDirectory=<path-to-repo>/MACHINE-LEARNING/Feature Learning
ExecStart=<path-to-repo>/MACHINE-LEARNING/Feature Learning/venv/bin/jupyter notebook --config=/home/user/.jupyter/jupyter_notebook_config.py
Restart=always
RestartSec=10
